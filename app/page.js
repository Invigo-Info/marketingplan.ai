    ...
    <main className="main-container">
      ...
      <div className="content">
        ...
        <span className="badge">
          WORLD&apos;S BEST AI-POWERED Marketing Plan Generator
        </span>

        {/* Main Title */}
        <h1 className="title">
          Craft expert, data-driven marketing plans tailored to your business&mdash;in minutes          
        </h1>

        {/* Subtitle */}
        <p className="subtitle">
          Sign up now for early access and be among the first to elevate your marketing strategy!
        </p>
